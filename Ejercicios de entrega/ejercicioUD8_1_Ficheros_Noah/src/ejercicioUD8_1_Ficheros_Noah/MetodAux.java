...
public class MetodAux {
	...
	public static int menuOpciones(String titulo, String opciones[], String peticion) {
		...
		do {
			...
			MainFicheros.entrada = MainFicheros.teclado.nextLine().trim();
			
			if (!MainFicheros.entrada.isEmpty() && checkSoloNumeroPositivoEntero(MainFicheros.entrada)) {
				
				opcionSeleccionada = Integer.parseInt(MainFicheros.entrada);
